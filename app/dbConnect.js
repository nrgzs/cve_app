...
//   dialect: "sqlite",
//   dialectOptions: {
//     timeout: 10000 // Increase timeout to 10 seconds (or higher as needed)
//   },
//   storage: "./cve_data.db", // Path to SQLite database file
//   logging: false, // Disable SQL query logging
// });
...
//           attempts++;
//           console.warn(
//             `Error saving to database (attempt ${attempts}/${maxAttempts}): SQLITE_BUSY. Retrying...`
//           );
//           await new Promise((resolve) => setTimeout(resolve, 1000)); // Wait 1 second before retrying
//         } else {
//           console.error("Error saving to database:", error.message);
...
//     if (!success) {
//       console.error(
//         `Failed to save CVE ${cve} for ${app.product} after ${maxAttempts} attempts.`
//       );
//     }
//   }
// }
...
// databse e save edende timstamp olmalidi ki sonradan muqayise edende feeq buna gore olswun yeni tutailm son 1 ayin cvleri icinde tapsin ya da sayla tutalin son 30 cve filan muqayise elesein ki sonra cokmesin birde database save edende app uzre filterlemek lazimdi ki ancaq o appin son cvelerini gotursun ona da orm lazimdu
